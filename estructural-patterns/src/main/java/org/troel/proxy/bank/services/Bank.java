package org.troel.proxy.bank.services;

import java.util.HashMap;
import java.util.Map;

import org.troel.proxy.bank.model.User;
...
public class Bank implements BankOperations {
	...
	public void changePassword(Long account, String oldPassword, String newPassword) {
		...
		System.out.println(String.format("%s's password updated successfuly!", user.getName()));
	}
}
